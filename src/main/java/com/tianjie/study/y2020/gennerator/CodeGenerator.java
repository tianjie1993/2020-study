package com.tianjie.study.y2020.gennerator;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String url = "jdbc:mysql://goupwith.mysql.rds.aliyuncs.com:3306/datav?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true&zeroDateTimeBehavior=convertToNull";
        String userName ="datav";
        String passWord ="Hex@1324";
...
// pc.setModuleName("test");
        pc.setParent("com.hex.datav.app");// 自定义包路径
